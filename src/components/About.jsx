        ...
        <div className="flex flex-col md:flex-row gap-7 items-center">
          <div className="md:w-1/2 space-y-5">
            ...
            <p className="text-gray-300">
              Welcome to Hindustani Web solutions, where we blend creativity,
              strategy, and technology to help businesses excel in the digital
              landscape. Founded in 2025, we are a young and dynamic digital
              marketing agency based in Ghaziabad, dedicated to delivering
              results-driven solutions tailored to your unique business goals.
              Our mission is simple – to empower brands with powerful digital
              strategies that elevate online presence, engage audiences, and
